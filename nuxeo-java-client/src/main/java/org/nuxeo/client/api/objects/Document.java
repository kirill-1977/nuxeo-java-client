...
public class Document extends NuxeoEntity {
    ...
    @JsonIgnore
    protected static final String MSG_DATE_UNSUPPORTED = "Date values are not supported in Nuxeo Java Client. Please"
            + "convert it to String with ISO 8601 format \"yyyy-MM-dd'T'HH:mm:ss.SSX\" before calling this method.";
